...
const registerBabelLoaderPlugins = require('../plugin/babel/registerLoaderPlugins')
...
ConfigService.chainDefaultWebpack = function(chainConfig) {
  ...
  try {
    ...
    registerBabelLoaderPlugins(chainConfig, {
